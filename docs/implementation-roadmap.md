...
- `[ ]` Open expansion track: finalize the product boundary, contract shape, and phased implementation plan for `Wellness Programs` before runtime implementation begins. Controlled through `docs/wellness-program-execution-checklist.md`.
