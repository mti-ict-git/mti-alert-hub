...
const map: Record<string, { className: string }> = {
  ...
  Triggered: { className: "bg-info text-info-foreground" },
  Started: { className: "bg-success text-success-foreground" },
  Snoozed: { className: "bg-warning text-warning-foreground" },
  StepAdvanced: { className: "bg-info text-info-foreground" },
